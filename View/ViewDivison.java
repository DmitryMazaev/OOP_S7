...
public class ViewDivison implements iCalculDivision{
    ...
    public void calcDivision(ComplexNumber complexNumber1, ComplexNumber complexNumber2) {
        ...
        {
            System.out.println("Сумма комплексных чисел " + complexNumber1.toStringMinus() + " и " + complexNumber2.toStringMinus() + " равна "+ div1 + " - i*" + (-div2));
        }
        if (div2 < 0 && complexNumber1.getB() > 0 && complexNumber2.getB() < 0)
        {
            System.out.println("Сумма комплексных чисел " + complexNumber1.toStringPlus() + " и " + complexNumber2.toStringMinus() + " равна "+ div1 + " - i*" + (-div2));
        }
        if (div2 < 0 && complexNumber1.getB() < 0 && complexNumber2.getB() > 0)
        {
            System.out.println("Сумма комплексных чисел " + complexNumber1.toStringMinus() + " и " + complexNumber2.toStringPlus() + " равна "+ div1 + " - i*" + (-div2));
        }
        if (div2 < 0 && complexNumber1.getB() > 0 && complexNumber2.getB() > 0)
        {
            System.out.println("Сумма комплексных чисел " + complexNumber1.toStringPlus() + " и " + complexNumber2.toStringPlus() + " равна "+ div1 + " - i*" + (-div2));
        }
        if (div2 > 0 && complexNumber1.getB() > 0 && complexNumber2.getB() > 0)
        {
            System.out.println("Сумма комплексных чисел " + complexNumber1.toStringPlus() + " и " + complexNumber2.toStringPlus() + " равна "+ div1 + " + i*" + div2);
